...
public class SettingsActivity extends AppCompatActivity {
    ...
    private void updateGoalValueText(int minutes) {
        if (minutes >= 60) {
            ...
            int mins = minutes % 60;
            if (mins > 0) {
                goalValueText.setText(getString(R.string.hours_minutes_format, hours, mins));
            } else {
                goalValueText.setText(getString(R.string.hours_format, hours));
            }
        } else {
            goalValueText.setText(getString(R.string.minutes_format, minutes));
        }
    }
