package com.focusflip.app.database;
...
public class StudySessionDao {
     ...
     */
    public int getGoalsAchievedCount() {
        // This would need the daily goal from preferences
        // For now, return count of days with any study time
        String query = "SELECT COUNT(DISTINCT date(" + StudyDatabase.COLUMN_START_TIME 
                + "/1000, 'unixepoch', 'localtime')) FROM " + StudyDatabase.TABLE_SESSIONS;
